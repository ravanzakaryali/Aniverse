...
namespace Aniverse.API.Controllers
{
    ...
    public class PostsController : ControllerBase
    {
        ...
        //[HttpGet("posts/{id}/files")]
        //public async Task<IActionResult> GetAllPostFiles(string id)

        [HttpGet("users/{username}/[controller]")] // api/users/revanzli/posts?page=1&size=10
